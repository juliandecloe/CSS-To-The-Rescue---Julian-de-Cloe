...
After a lot of messing around I came to the conclusion that this was not the way to do it. I needed to rotate the elements with a calculation so that all elements where rotated the exact degrees. This was harder than I thought because I only want them to rotate over a specific degrees. They can't go further than 60 deg in total over 7 `<li>` elements.
